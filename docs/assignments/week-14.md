# Week 14 - Documentation, versioning, and a look back
...
<!--
  ...
  What is already true, and does not need restating here:
    Endpoint stub   src/Fleet.Api.Workshop/Endpoints/NotificationEndpoints.cs
    Module contract INotificationService
