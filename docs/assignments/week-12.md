# Week 12 - Resilience: timeouts, retries and circuit breakers
...
<!--
  ...
  What is already true, and does not need restating here:
    Endpoint stub   src/Fleet.Api.Workshop/Endpoints/WorkOrderEndpoints.cs
    Module contract IMaintenanceService
