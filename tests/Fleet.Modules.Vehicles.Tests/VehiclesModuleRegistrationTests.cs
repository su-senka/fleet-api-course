...
/// <summary>
/// Guards the module's one public seam: <c>AddVehiclesModule</c>.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class VehiclesModuleRegistrationTests
{
    ...
    {
        Assert.Equal("vehicles", VehiclesModuleExtensions.SchemaName);
    }
}
